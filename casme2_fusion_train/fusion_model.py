...
class LateFusionResNet(nn.Module):
    """
    Late Fusion ResNet model that combines RGB and MHI features
    ...
    def forward(self, rgb_input, mhi_input):
        """
        ...
        fused_features = torch.cat([rgb_features, mhi_features], dim=1)  # (batch_size, 1024)
