...
# Override the model factory to inject transfer weights while keeping SPP fusion architecture
def _factory(num_classes=5, dropout_p=0.5, pretrained=True):
...
# Result directory under this module folder (relative to script)
ft.RESULT_DIR = os.path.join(SCRIPT_DIR, 'fusion_result_spp_transfer_5class')
