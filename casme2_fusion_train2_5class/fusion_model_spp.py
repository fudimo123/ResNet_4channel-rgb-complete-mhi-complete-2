...
class LateFusionResNetWithSPP(nn.Module):
    ...
    and classified.
    """
    def __init__(self, num_classes=5, dropout_p=0.5, pretrained=True, spp_levels=(1, 2, 4), transfer_weights_path=None):
        super().__init__()
...
def create_fusion_model_with_transfer(num_classes=5, dropout_p=0.5, pretrained=True, transfer_weights_path=None):
