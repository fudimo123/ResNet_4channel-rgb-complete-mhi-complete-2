...
from single_dynamic_dataset import CASME2SingleDynamicDataset
from single_dynamic_models import create_single_dynamic_model


RESULT_DIR = "dynamic_single_result"
MODEL_NAME = "plain_resnet18"
TRANSFER_WEIGHTS_PATH = None
PROCESSED_DYNAMIC_DIR = "./casme2_dynamic_images_offline"
MANIFEST_FILE = "./casme2_single_dynamic_manifest.csv"
NUM_EPOCHS = 60
BATCH_SIZE = 16
...
def main():
    ...
    print(f"Starting CASME2 dynamic single-channel training: {MODEL_NAME}")
    print(
    ...
    for run_idx, seed in enumerate(REPRODUCIBILITY_SEEDS):
        ...
        for fold_idx, test_subject in enumerate(all_subjects):
            ...
            train_dataset = CASME2SingleDynamicDataset(
                train_samples,
                transform=train_transform,
                processed_dynamic_root=PROCESSED_DYNAMIC_DIR,
            )
            val_dataset = CASME2SingleDynamicDataset(
                val_samples,
