...
OUTPUT_PATH = Path(
    r"D:\Users\fuziyan\PycharmProjects\ResNet_4channel-rgb-complete-mhi-complete-2\paper_visualization\average_training_validation_accuracy_combined-2_color.png"
)
...
def main():
    ...
    plt.close(fig)
    print(f"Saved colored combined accuracy figure to: {OUTPUT_PATH}")
