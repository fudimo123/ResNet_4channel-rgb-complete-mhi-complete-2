...
OUTPUT_PATH = Path(
    r"D:\Users\fuziyan\PycharmProjects\ResNet_4channel-rgb-complete-mhi-complete-2\paper_visualization\average_training_validation_accuracy_combined-2.png"
)
...
def main():
    ...
    ax.set_xlabel("训练轮次 ($x$/epoch)", fontproperties=CHINESE_FONT, fontsize=15, labelpad=10)
    ax.set_ylabel("准确率 ($y$/1)", fontproperties=CHINESE_FONT, fontsize=15, labelpad=10)
    ...
    plt.close(fig)
    print(f"Saved journal-style combined accuracy figure to: {OUTPUT_PATH}")
