...
from fusion_model import create_fusion_model_with_transfer

# --- Configuration ---
# You can change the result directory name here
ft.RESULT_DIR = 'fusion_result_asym'
...
def main():
    print(f"Starting Fusion Training with Asymmetric Architecture (GAP for RGB, SPP for Dynamic) and Transfer Learning...")
    ...
    ft.create_fusion_model = lambda num_classes, dropout_p, pretrained: \
        create_fusion_model_with_transfer(
