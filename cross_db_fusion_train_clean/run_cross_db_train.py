...
# --- Configuration ---
RESULT_DIR = 'fusion_result_cross_db_se'
NUM_EPOCHS = 60
BATCH_SIZE = 16
...
# Dataset Config
# We no longer need a centralized dynamic dir because each parser handles its own dynamic images
...
def main():
    ...
    final_criterion = FocalLossLabelSmoothing(gamma=2.0, smoothing=0.1)
