...
ft.RESULT_DIR = os.path.join(SCRIPT_DIR, 'fusion_result_casme2_se_reprofix_evm_alpha10_decal_ratio_ps05_sr1')
...
ft.STATIC_AUG_DIR = os.path.join(SCRIPT_DIR, 'casme2_static_decalcomanie_evm_alpha10')
