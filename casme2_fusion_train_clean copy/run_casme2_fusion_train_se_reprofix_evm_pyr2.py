...
ft.RESULT_DIR = os.path.join(SCRIPT_DIR, 'fusion_result_casme2_se_reprofix_evm_pyr2')
ft.ALIGNED_RGB_DIR = os.path.join(SCRIPT_DIR, 'casme2_aligned_rgb_evm_pyr2')
ft.DYNAMIC_IMAGE_DIR = os.path.join(SCRIPT_DIR, 'casme2_dynamic_data_evm_pyr2')
...
def main():
    ...
    print("Starting CASME2 Fusion Training with SE-Fusion (reprofix + pyr2)...")
