...
from casme2_static_augmentation_schemeB import append_augmented_static_samples
from focal_loss_ls import FocalLossLabelSmoothing
from fusion_model_se import create_fusion_model_se


SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
ft.RESULT_DIR = os.path.join(SCRIPT_DIR, 'fusion_result_casme2_se_reprofix_decal_possur_rand1')
...
ft.STATIC_AUG_KWARGS = {'max_variants_per_sample': 1}
