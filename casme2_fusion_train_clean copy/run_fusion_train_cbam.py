...
from fusion_model_cbam import create_fusion_model_with_cbam

# --- Configuration ---
# You can change the result directory name here
ft.RESULT_DIR = 'fusion_result_asym_cbam'
...
def main():
    print(f"Starting Fusion Training with Asymmetric Architecture (CBAM+GAP for RGB, SPP for Dynamic) and Transfer Learning...")
