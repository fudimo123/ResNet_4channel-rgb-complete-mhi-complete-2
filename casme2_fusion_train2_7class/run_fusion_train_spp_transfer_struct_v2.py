import os
try:
    from . import fusion_train_struct_v2 as ft
    from .fusion_model_spp_struct_v2 import create_fusion_model_with_transfer
except ImportError:
    import fusion_train_struct_v2 as ft
    from fusion_model_spp_struct_v2 import create_fusion_model_with_transfer
...
ft.RESULT_DIR = os.path.join(SCRIPT_DIR, 'fusion_result_spp_transfer_7class_struct_v2')
