import os
try:
    from . import fusion_train_uar_alpha as ft
    from .fusion_model_spp import create_fusion_model_with_transfer
except ImportError:
    import fusion_train_uar_alpha as ft
    from fusion_model_spp import create_fusion_model_with_transfer
...
ft.RESULT_DIR = os.path.join(SCRIPT_DIR, 'fusion_result_spp_transfer_7class_uar_alpha')
