...
ft.RESULT_DIR = os.path.join(SCRIPT_DIR, 'fusion_result_samm_se_reprofix_decal_ratio_ps1_sr05')
...
def main():
    ...
    print("Strategy: Train Random Frame RGB + static L/R ratio control (positive=1.0, surprise=0.5) + Val/Test Middle Frame RGB")
