...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Build offline O/L/R static Decalcomanie samples from preprocessed SAMM RGB sequences."
    )
    parser.add_argument(
        "--input-dir",
        default=str(script_dir / "samm_aligned_rgb"),
        help="Input directory containing preprocessed SAMM RGB sequences.",
    )
    parser.add_argument(
        "--output-dir",
        default=str(script_dir / "samm_static_decalcomanie"),
...
def main():
    ...
    print(f"Found {len(sequences)} SAMM sequences under {args.input_dir}")
