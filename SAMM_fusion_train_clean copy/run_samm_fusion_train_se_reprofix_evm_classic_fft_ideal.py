...
ft.RESULT_DIR = os.path.join(SCRIPT_DIR, 'fusion_result_samm_se_reprofix_evm_classic_fft_ideal')
ft.ALIGNED_RGB_DIR = os.path.join(SCRIPT_DIR, 'samm_aligned_rgb_evm_classic_fft_ideal')
ft.DYNAMIC_IMAGE_DIR = os.path.join(SCRIPT_DIR, 'samm_dynamic_data_evm_classic_fft_ideal')
...
def main():
    ...
    print("Starting SAMM Fusion Training with SE-Fusion (Adaptive Weighting, reprofix + classic_fft_ideal)...")
