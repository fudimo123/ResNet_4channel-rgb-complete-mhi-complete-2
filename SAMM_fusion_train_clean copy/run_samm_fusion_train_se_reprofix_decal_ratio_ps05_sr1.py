...
ft.RESULT_DIR = os.path.join(SCRIPT_DIR, 'fusion_result_samm_se_reprofix_decal_ratio_ps05_sr1')
...
def main():
    ...
    print("Strategy: Train Random Frame RGB + static L/R ratio control (positive=0.5, surprise=1.0) + Val/Test Middle Frame RGB")
