...
ft.RESULT_DIR = os.path.join(SCRIPT_DIR, 'fusion_result_samm_se_reprofix')
...
def main():
    ...
    print(f"Starting SAMM Fusion Training with SE-Fusion (Adaptive Weighting, reprofix)...")
    print(f"Architecture: RGB(Grid+CBAM) + Dyn(SPP) -> Concat -> SE Block")
    print(f"Strategy: Train Random Frame RGB + Val/Test Middle Frame RGB + Label Smoothing (0.1)")
