...
AUG_RESULT_DIR = 'fusion_result_smic_se_reprofix_fullstd_decal_lr_possur'
...
SMIC_RGB_DIR = 'smic_aligned_rgb_fullstd'
DYNAMIC_IMAGE_DIR = 'smic_dynamic_data_fullstd'
STATIC_AUG_DIR = 'smic_static_decalcomanie_fullstd'
...
def main():
    print(f"Starting SMIC Fusion Training with SE-Fusion (Adaptive Weighting, full standardized frames)...")
    print(f"Architecture: RGB(Grid+CBAM) + Dyn(SPP) -> Concat -> SE Block")
    print(f"Strategy: Full standardized frames (no 16-frame cleaning) + Random Frame RGB (train) + Middle Frame RGB (val/test) + Label Smoothing (0.1)")
