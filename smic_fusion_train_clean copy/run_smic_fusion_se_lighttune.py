...
from smic_static_augmentation import append_augmented_static_samples

# --- Configuration ---
USE_STATIC_AUG = True
BASELINE_RESULT_DIR = 'fusion_result_smic_se_reprofix'
AUG_RESULT_DIR = 'fusion_result_smic_se_reprofix_decal_lr_possur_lighttune'
...
def main():
    ...
    print("Light tuning: dropout=0.65, weight_decay=2e-3, patience=20")
    ...
    for run in range(1, NUM_RUNS + 1):
        ...
        for i, test_sub in enumerate(subjects):
            ...
            optimizer = torch.optim.Adam(model.parameters(), lr=0.0001, weight_decay=2e-3)
