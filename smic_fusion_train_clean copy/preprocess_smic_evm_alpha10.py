...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Offline EVM preprocessing for SMIC (alpha=10): align/crop -> EVM -> TIM(16) -> dynamic image."
    )
    parser.add_argument(
        "--raw-dir",
    ...
    parser.add_argument(
        "--output-dyn-dir",
        default=str(script_dir / "smic_dynamic_data_evm_alpha10"),
...
def main():
    ...
    summary_path = Path(args.output_rgb_dir).parent / "preprocess_smic_evm_alpha10_summary.json"
