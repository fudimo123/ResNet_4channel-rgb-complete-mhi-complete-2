...
EVM_RESULT_DIR = 'fusion_result_smic_se_reprofix_evm_alpha10_decal_lr_possur'
...
SMIC_RGB_DIR = 'smic_aligned_rgb_evm_alpha10'
DYNAMIC_IMAGE_DIR = 'smic_dynamic_data_evm_alpha10'
STATIC_AUG_DIR = 'smic_static_decalcomanie_evm_alpha10'
...
def main():
    print(f"Starting SMIC Fusion Training with SE-Fusion (Adaptive Weighting, EVM alpha=10 + selective static L/R)...")
    ...
    print(f"Static augmentation dir: {STATIC_AUG_DIR}")
