...
from smic_static_augmentation_ratio import append_augmented_static_samples

# --- Configuration ---
USE_STATIC_AUG = True
BASELINE_RESULT_DIR = 'fusion_result_smic_se_reprofix'
AUG_RESULT_DIR = 'fusion_result_smic_se_reprofix_decal_ratio_ps1_sr05'
...
def main():
    ...
    print(f"Static augmentation emotion ratios: {STATIC_AUG_EMOTION_RATIOS}")
