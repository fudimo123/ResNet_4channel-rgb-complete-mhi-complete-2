...
EVM_RESULT_DIR = 'fusion_result_smic_se_reprofix_evm_classic'
...
SMIC_RGB_DIR = 'smic_aligned_rgb_evm_classic'
DYNAMIC_IMAGE_DIR = 'smic_dynamic_data_evm_classic'
...
def main():
    print(f"Starting SMIC Fusion Training with SE-Fusion (Adaptive Weighting, classic EVM-only)...")
    print(f"Architecture: RGB(Grid+CBAM) + Dyn(SPP) -> Concat -> SE Block")
    print(f"Strategy: Align/Crop -> Classic EVM -> TIM(16) -> Random Frame RGB (train) + Middle Frame RGB (val/test) + Label Smoothing (0.1)")
