...
from smic_static_augmentation_schemeB import append_augmented_static_samples

# --- Configuration ---
USE_STATIC_AUG = True
BASELINE_RESULT_DIR = 'fusion_result_smic_se_reprofix'
AUG_RESULT_DIR = 'fusion_result_smic_se_reprofix_decal_possur_rand1'
...
STATIC_AUG_MAX_VARIANTS_PER_SAMPLE = 1
...
def main():
    ...
    print(f"Static augmentation max variants per sample: {STATIC_AUG_MAX_VARIANTS_PER_SAMPLE}")
        ...
        for i, test_sub in enumerate(subjects):
            ...
            if USE_STATIC_AUG:
                train_samples = append_augmented_static_samples(
                    ...
                    max_variants_per_sample=STATIC_AUG_MAX_VARIANTS_PER_SAMPLE
                )
