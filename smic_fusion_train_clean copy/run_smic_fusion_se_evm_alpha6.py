...
EVM_RESULT_DIR = 'fusion_result_smic_se_reprofix_evm_alpha6'
...
SMIC_RGB_DIR = 'smic_aligned_rgb_evm_alpha6'
DYNAMIC_IMAGE_DIR = 'smic_dynamic_data_evm_alpha6'
...
def main():
    print(f"Starting SMIC Fusion Training with SE-Fusion (Adaptive Weighting, EVM-only alpha=6)...")
