...
EVM_RESULT_DIR = 'fusion_result_smic_se_reprofix_evm_fh25'
...
SMIC_RGB_DIR = 'smic_aligned_rgb_evm_fh25'
DYNAMIC_IMAGE_DIR = 'smic_dynamic_data_evm_fh25'
...
def main():
    print(f"Starting SMIC Fusion Training with SE-Fusion (Adaptive Weighting, EVM-only freq_high=2.5)...")
