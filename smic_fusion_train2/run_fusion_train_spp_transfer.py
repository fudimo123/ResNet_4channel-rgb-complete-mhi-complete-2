...
# Resolve JAFFE transfer weights via relative path; allow override via env
SCRIPT_DIR = os.path.dirname(__file__)
REPO_ROOT = os.path.dirname(SCRIPT_DIR)
DEFAULT_TRANSFER_WEIGHTS = os.path.join(REPO_ROOT, 'casme_rgb_train', 'jaffe', 'resnet18_jaffe_final_model_for_transfer.pth')
...
# Override factory to use SPP with transfer learning
ft.create_fusion_model = _factory

# Save results into a distinct SPP transfer directory under current module
