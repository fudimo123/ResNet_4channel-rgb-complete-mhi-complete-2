...
def main():
    ...
    config = {
        ...
        'MODEL': 'Weighted Voting Late Fusion ResNet-18 (RGB, Dynamic, MHI)',
        ...
        'fusion_architecture': 'Weighted voting late fusion at logits level (w_rgb*logits_rgb + w_dyn*logits_dyn + w_mhi*logits_mhi -> 3 classes)',
        'optimizations': {
