...
DYNAMIC_IMAGE_DIR = './dynamic_image'
MHI_IMAGE_DIR = './mhi_image'
RESULT_DIR = 'fusion_result3'
NUM_EPOCHS = 60
BATCH_SIZE = 16
...
def main():
    ...
    config = {
        ...
        'MODEL': 'Weighted Voting Late Fusion ResNet-18 with AdamW, Grad Clip, CosineAnnealingLR',
        ...
        for fold_idx, test_subject in enumerate(all_subjects):
            ...
            for epoch in range(NUM_EPOCHS):
                ...
                for rgb_images, dynamic_images, mhi_images, labels in train_loader:
                    ...
                    mhi_images = mhi_images[valid_mask]
                    labels = labels[valid_mask]
                    
                    rgb_images, dynamic_images, mhi_images, labels = rgb_images.to(device), dynamic_images.to(device), mhi_images.to(device), labels.long().to(device)
