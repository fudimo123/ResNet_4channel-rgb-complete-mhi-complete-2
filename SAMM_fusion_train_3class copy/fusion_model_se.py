...
def create_fusion_model_se(num_classes=3, dropout_p=0.5, pretrained=True, transfer_weights_path=None):
    """Factory to create SE Fusion model."""
    return LateFusionResNetSE(
